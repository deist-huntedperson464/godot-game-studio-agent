...
3. If starting fresh, use `scripts/start-game-project.ps1 -Engine godot|unity|unreal` to create the project structure and starter design docs.
...
- Generated art: `art/` for concepts, engine-appropriate runtime asset folders for imported assets
